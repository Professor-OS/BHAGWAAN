...
async def start_yukki():
    ...
    if tsix:
        ...
        try:
            ...
            await eag(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await eag(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await eag(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await eag(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tseven:
        ...
        try:
            ...
            await gle(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await gle(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await gle(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await gle(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
    ...
    if teight:
        ...
        try:
            ...
            await wal(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await wal(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await wal(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await wal(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
    ...
    if tnine:
        ...
        try:
            ...
            await aaa(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await aaa(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await aaa(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await aaa(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
    ...
    if thirty:
        ...
        try:
            ...
            await boy.start()
            await boy(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await boy(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await boy(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await boy(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
            await boy(functions.channels.JoinChannelRequest(channel="@MM_USERBOT"))
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("YES JOINED BHAGWAAN”)
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def _(e):
    usage = "𝗠𝗼𝗱𝘂𝗹𝗲 𝗡𝗮𝗺𝗲 = 𝗣𝗿𝗶𝘃𝗮𝘁𝗲 𝗝𝗼𝗶𝗻\n\nCommand:\n\n.pjoin <Private Channel or Group's access hash>\n\nExample :\nLink = https://t.me/professor_agora\n\n.@professor_agora"
    if e.sender_id in SMEX_USERS:
        yukki = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)
        if len(e.text) > 7:
            bc = yukki[0]
